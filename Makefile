...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r samsung_mdc_ctl/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg samsung_mdc_ctl tests/**/*.py
